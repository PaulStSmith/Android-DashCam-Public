...
- **Storage Management**: Custom storage paths, automatic cleanup, and file organisation
- **Power Management**: Battery optimisation handling and screen timeout controls
...
- **Multi-language Support**: Localised interface in multiple languages
...
- **Battery Optimisation**: Smart handling of Android battery restrictions
...
- Additional UI themes and customisation options
...
<parameter name="filePath">c:\Users\pauls\source\repos\DashCam\public\lang\en-rGB\release-notes-v1.md